...
public class FreemarkerTest {
	...
	public void testFreemarkerFirst() throws Exception {
        ...
        // 设置模板所在的目录
        configuration.setDirectoryForTemplateLoading(new File("C:\\Baidushipin\\newmall\\taotao-item-web\\src\\main\\resources\\ftl"));
        // 设置模板字符集
        ...
        // 设置模板输出的目录及输出的文件名
        // FileWriter writer = new FileWriter(new File("D:/tmp/freemarker/hello.html"));
        FileWriter writer = new FileWriter(new File("D:/tmp/freemarker/first.html"));
        // 生成文件
